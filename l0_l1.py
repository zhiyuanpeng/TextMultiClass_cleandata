...
x_write(X_train, "data/store/l0_l1_X_train.txt")
x_write(X_test, "data/store/l0_l1_X_test.txt")
y_write(y_train, "data/store/l0_l1_y_train.txt")
y_write(y_test, "data/store/l0_l1_y_test.txt")
#
...
y_write(predict_list, "data/store/l0_l1_predict.txt")
y_write_round(predict_list, "data/store/l0_l1_predict_round.txt")
right_sum = 0
...
# save the result
with open("data/store/l0_l1_result.txt", "a+") as r:
