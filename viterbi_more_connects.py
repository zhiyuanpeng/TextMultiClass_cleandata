...
def get_transfer_matrix(link_list):
    ...
    for line in transfer_data:
        ...
        transfer_matrix[4, 5] = line[5]
        transfer_matrix[1, 4] = line[6]
        transfer_matrix[0, 2] = line[7]
        #
        ...
        transfer_matrix[5, 4] = line[5]
        transfer_matrix[4, 1] = line[6]
        transfer_matrix[2, 0] = line[7]
...
def main():
    ...
    link_path_list = ["l0_l1_predict.txt", "l0_l3_predict.txt", "l0_l4_predict.txt", "l0_l5_predict.txt"
                      , "l1_l2_predict.txt", "l4_l5_predict.txt", "l1_l4_predict.txt", "l0_l2_predict.txt"]
    ...
    with open("data/store/viterbi_more_connects_result.txt", "a+") as vf:
