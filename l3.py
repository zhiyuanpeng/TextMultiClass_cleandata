...
toxic_comments_labels = toxic_comments[["threat"]]
...
x_write(X_train, "data/store/l3_X_train.txt")
x_write(X_test, "data/store/l3_X_test.txt")
y_write(y_train, "data/store/l3_y_train.txt")
y_write(y_test, "data/store/l3_y_test.txt")
#
...
y_write(predict_list, "data/store/l3_predict.txt")
y_write_round(predict_list, "data/store/l3_predict_round.txt")
right_sum = 0
...
# save the result
with open("data/store/l3_result.txt", "a+") as r:
