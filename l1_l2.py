...
y = np.array(toxic_comments[["severe_toxic"]])*np.array(toxic_comments[["obscene"]])
...
x_write(X_train, "data/store/l1_l2_X_train.txt")
x_write(X_test, "data/store/l1_l2_X_test.txt")
y_write(y_train, "data/store/l1_l2_y_train.txt")
y_write(y_test, "data/store/l1_l2_y_test.txt")
#
...
y_write(predict_list, "data/store/l1_l2_predict.txt")
y_write_round(predict_list, "data/store/l1_l2_predict_round.txt")
right_sum = 0
...
# save the result
with open("data/store/l1_l2_result.txt", "a+") as r:
