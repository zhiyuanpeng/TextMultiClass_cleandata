...
# for node 0
y_train = np.loadtxt("data/processed/y_train.txt", dtype=int)[:, 4]
y_test = np.loadtxt("data/processed/y_test.txt", dtype=int)[:, 4]
#
...
y_write(predict_list, "data/store/l4/l4_predict.txt")
y_write_round(predict_list, "data/store/l4/l4_predict_round.txt")
y_predict_round = []
...
l4_con_mat = confusion_matrix(list(y_test), y_predict_round)
...
# save the result
with open("data/store/l4/l4_result.txt", "a+") as r:
    r.write("\n")
    r.write("\n")
