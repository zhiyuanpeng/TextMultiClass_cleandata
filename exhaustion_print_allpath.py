    ...
    for one_possible in all_possible:
        ...
        for index in range(len(one_possible)):
            if index != 0:
                ...
                print("added transfer " + str(index -1) + " to " + str(index) + " log possibility is" + str(label_trans_matrix[one_possible[index - 1], one_possible[index]]))
...
def main():
    ...
    exhust_search("original_edge_truth_print_0_575.txt", 0)
