...
x_write(X_train_new, "data/store/l0_l4_b_X_train.txt")
x_write(X_test, "data/store/l0_l4_b_X_test.txt")
y_write(y_train_new, "data/store/l0_l4_b_y_train.txt")
y_write(y_test, "data/store/l0_l4_b_y_test.txt")
#
...
history = model.fit(X_train_new, y_train_new, batch_size=128, epochs=50, verbose=1, validation_split=0.2)
score = model.evaluate(X_test, y_test, verbose=1)
predict_list = model.predict(X_test, batch_size=128, verbose=1)
y_write(predict_list, "data/store/l0_l4_b_predict.txt")
y_write_round(predict_list, "data/store/l0_l4_b_predict_round.txt")
right_sum = 0
...
# save the result
with open("data/store/l0_l4_b_result.txt", "a+") as r:
...
model.save("models/l0_l4_b.h5")

epochs = len(history.history['loss'])
plt.plot(range(epochs), history.history['loss'], label='loss')
plt.plot(range(epochs), history.history['val_loss'], label='val_loss')
plt.legend()
plt.savefig("data/img/l0_l4_b_grad_50.png")
plt.show()
